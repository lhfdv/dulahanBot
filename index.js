...
client.on('message', message => {
    ...
    if ( message.content.includes('@') || message.content.includes('bonk') ) {
	    ...
	    message.channel.overwritePermissions([{id: '600046504056455208', deny: ['SEND_MESSAGES']}])
	    message.channel.overwritePermissions([{id: '550504173125500931', deny: ['SEND_MESSAGES']}])
