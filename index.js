...
client.on('message', message => {
    ...
    if ( message.content.includes('@') || message.content.includes('bonk') ) {
	    ...
	    message.channel.overwritePermissions('600046504056455208', { SEND_MESSAGES: false})
	    message.channel.overwritePermissions('550504173125500931', { SEND_MESSAGES: false})
